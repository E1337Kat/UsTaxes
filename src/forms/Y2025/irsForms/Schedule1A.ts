...
export default class Schedule1A extends F1040Attachment {
  ...
  // Line 4a: Qualified tips on Form W-2 box 7 (subject to SS/Medicare)
  // TODO: requires W-2 box 7 data not yet in the data model
  ...
  l15 = (): number | undefined => {
    ...
    return Math.min(c, this.isMFJ() ? 25000 : 12500)
  }
  ...
  l24 = (): number | undefined => {
    ...
    return Math.min(twentyThree, 10000)
  }
  ...
  fields = (): Field[] => [
    ...
    undefined, // 22a (i) VIN
    this.l22aIii(), // 22a (ii) already deducted on Sch C/E/F
    this.l22aIii(), // 22a (iii) Schedule 1-A amount
    undefined, // 22b (i) VIN
    this.l22bIii(), // 22b (ii) already deducted on Sch C/E/F
